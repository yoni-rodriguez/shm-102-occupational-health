...
:::: {.column width="28%"}
::: {style="display:flex; justify-content:center; align-items:center; height:100%;"}
![](poll-everywhere-response.jpg){fig-alt="QR code to join the SHM 102 Poll Everywhere presentation" width="250"}
:::
::::
:::::::
...
::: {style="font-size: 0.85em; color: #666; margin-top: 1rem;"}
**Photos:** Cesar Ramirez and Matteo Vijarro.\
**Research supported by:** [Pacific Northwest Agricultural Safety and Health Center (PNASH)](https://pnash.deohs.washington.edu/), University of Washington.
:::
...
::: {style="text-align:center; margin: 4rem 0;"}
### If a hazard can affect health, What can we do about it?
:::
...
When you're ready, submit your responses through Poll Everywhere.
...
::: {style="text-align:center; margin: 3rem 0;"}
### Can we measure environmental conditions and use that information before exposure occurs?
:::
...
::: {style="margin: 3rem auto; max-width: 1000px;"}

<div class="hazard-tree">

<div class="hazard-tree-parent">
<strong>Occupational Health</strong>
</div>

<div class="hazard-tree-stem"></div>

<div class="hazard-tree-branches">
  <div class="hazard-category">Chemical</div>
  <div class="hazard-category">Physical</div>
  <div class="hazard-category">Biological</div>
  <div class="hazard-category">Ergonomic</div>
  <div class="hazard-category">Psychosocial</div>
</div>
...
|---|---|
| **Identify Hazards** | Recognize conditions or agents that could cause harm so future or recurring exposures can be prevented. |
| **Measure Hazards** | Collect accurate information about the hazard and its source so we can determine where and when exposure is occurring. |
| **Assess Hazards** | Understand the hazard, its source, the exposure context, and its significance within a specific workplace or setting. |
| **Control Hazards** | Develop effective interventions that eliminate or reduce the hazard or exposure using the **Hierarchy of Controls**. |

::: {style="text-align:center; margin: 2.5rem 0;"}
