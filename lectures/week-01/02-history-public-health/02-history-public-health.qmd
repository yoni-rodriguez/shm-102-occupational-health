...
![Google Earth map showing Rome and Messina in relation to Italy, Sicily, and the Mediterranean Sea.](map-01.jpg){fig-alt="Google Earth satellite map showing Rome in central Italy and Messina at the northeastern tip of Sicily." width="60%"}

:::

**Want to explore further?**\
[Explore Rome, Messina, and Dubrovnik in Google Earth](https://earth.google.com/earth/d/1REktiSIZv4oKlCb-nx_vpPkC30PHFLX5?usp=sharing)
...
## Do you wait until you know more?

### Or act now to prevent additional illness?
...
![Northwell Health infographic comparing isolation and quarantine.](northwell-isolation-vs-quarantine-2020.jpg){fig-alt="Northwell Health infographic explaining that isolation separates people who are sick from others, while quarantine restricts the movement of people who are not sick but may have been exposed."}

*Northwell Health, **Isolation vs. quarantine: Understanding the difference**, March 16, 2020. Information based on CDC and WHO guidance. [View source](https://www.matherhospital.org/wellness-at-mather/isolation-vs-quarantine-whats-the-difference/)*
...
![Google Earth map showing Rome, Messina, and Dubrovnik in relation to the Mediterranean and Adriatic Seas.](map-02.jpg){fig-alt="Google Earth satellite map showing Rome, Messina, and Dubrovnik, with Italy, Sicily, the Adriatic Sea, and surrounding Mediterranean region visible." width="85%"}
...
![Rock paintings depicting Neolithic farming and interactions between people and domesticated animals in Tassili de Maghidet, Libya.](neolithic-farming.jpg){fig-alt="Neolithic rock paintings showing people interacting with domesticated cattle in Tassili de Maghidet, Libya."}

*Rock paintings of Neolithic farming in Tassili de Maghidet, Libya. Photograph by Roberto Esposti/Alamy. [Source](https://swaledalelocalhistoryblog.wordpress.com/2017/12/06/how-neolithic-farming-sowed-the-seeds-of-modern-inequality-10000-years-ago/)*
...
![One Health Systems Model showing interactions among human, environmental, and animal systems across biological and societal scales.](one-health-systems-model.jpg){fig-alt="One Health Systems Model showing human, environmental, and animal systems connected through exposures, interactions, and risk across scales ranging from atoms and molecules to individuals, populations, ecosystems, and global society."}

*One Health Systems Model. Source: ENVH 501 Foundations of Environmental Health, University of Washington, “EOH Approach 1,” 2020.*
...
Ships did more than transport people.
...
### How can we prevent harm before more people become sick?
...
![New York Times coverage of the Grand Princess cruise ship arriving in San Francisco Bay during the COVID-19 outbreak in March 2020.](nyt-covid19-2020.jpg){fig-alt="New York Times article titled Cruise Ship, Floating Symbol of America's Fear of Coronavirus, Docks in Oakland, showing the Grand Princess cruise ship in San Francisco Bay."}
...
![New York Times coverage of suspected hantavirus infections associated with the MV Hondius expedition cruise ship in May 2026.](nyt-hantavirus-2026.jpg){fig-alt="New York Times article titled 3 Dead of Suspected Hantavirus Infections on Cruise Ship, WHO Says, showing the expedition cruise ship MV Hondius."}
...
In 1347, public health officials could observe illness and recognize patterns.

Today we can also use:
...
- contact tracing
- modern medical care
- rapidly shared scientific information

<br>

### Our ability to investigate disease has changed dramatically.

### The need to make decisions under uncertainty has not disappeared.
...
In 1347, people could:

- observe illness
- recognize patterns
- separate sick people
- restrict movement
- attempt to prevent additional disease

<br>

::: {style="text-align:center; margin: 3rem 0;"}

## But they still could not answer one question.
...
# We could see the disease.

# We could not see its cause.
